...
async def cmd_start(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    await update.message.reply_text(
        ...
        "Проекты: /projects /tree /cat /grep /stats"
    )
...
async def cmd_help(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    await update.message.reply_text(
        ...
        "Проекты (чтение файлов среды):\n"
        "/projects — список проектов\n"
        "/tree <project> [глубина] — дерево файлов\n"
        "/cat <project> <path> — содержимое файла\n"
        "/grep <project> <pattern> — поиск по содержимому\n"
        "/stats <project> — статистика проекта\n\n"
        "Также:\n"
